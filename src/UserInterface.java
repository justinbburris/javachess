...
public class UserInterface extends JPanel
  ...
  public void paintComponent(Graphics g) {
    ...
    this.setBackground(new Color(148, 113, 112));
    ...
    if (e.getX() < 8 * squareSize && e.getY() < 8 * squareSize) {
      ...
      if (e.getButton() == MouseEvent.BUTTON1) {
        ...
        if (newMouseY / squareSize == 0
          ...
          // Pawn promotion : assuming queen promotion
          dragMove = ""
                  + mouseX / squareSize
        ...
        if (userPossibilities.replaceAll(dragMove, "").length() < userPossibilities.length()) {
          ...
          AlphaBetaChess.makeMove(AlphaBetaChess.alphaBeta(AlphaBetaChess.globalDepth, 10000000, -10000000, "", 0));
          AlphaBetaChess.flipBoard();
          repaint();
        }
      }
